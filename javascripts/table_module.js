...
var table_module = (function(verbose) {
    ...
    function createEspList(rawdata = null) {
        ...
        $('#tdisplay').dataTable({
            ...
            "data": _data_list_eps,
            "columns": [
                {title: ' <div class="ttip"><button type="button" class="btn btn-light glyphicon glyphicon-info-sign btn_column"></button><div class="ttext"><h5>' + "Covariable" + '</h5><p>' + "Covariable" + '</p></div></div>' + "Covariable"},
                ...
                {title: ' <div class="ttip"><button type="button" class="btn btn-light glyphicon glyphicon-info-sign btn_column"></button><div class="ttext" style="width: 300px;"><h5>' + _iTrans.prop('lb_epsilon') + '</h5><p>' + _iTrans.prop('lb_msg_epsilon') + '</p><img src="images/epsilon.png"></div></div>' + _iTrans.prop('lb_epsilon')},
                {title: ' <div class="ttip"><button type="button" class="btn btn-light glyphicon glyphicon-info-sign btn_column"></button><div class="ttext" style="width: 300px;"><h5>' + _iTrans.prop('tip_tbl_score') + '</h5><p>' + _iTrans.prop('lb_msg_score') + '</p><img src="images/score.png"></div></div>' + _iTrans.prop('tip_tbl_score')},
                {title: ' <div class="ttip"><button type="button" class="btn btn-light glyphicon glyphicon-info-sign btn_column"></button><div class="ttext"><h5>' +"Categoría"+ '</h5><p>' + "Categoría" + '</p></div></div>' + "Categoría"},
                {title: ' <div class="ttip"><button type="button" class="btn btn-light glyphicon glyphicon-info-sign btn_column"></button><div class="ttext"><h5>' +"Fuente"+ '</h5><p>' + "Fuente" + '</p></div></div>' + "Fuente"},
                ...
                {title: ' <div class="ttip"><button type="button" class="btn btn-light glyphicon glyphicon-info-sign btn_column"></button><div class="ttext" ttip-left><h5>' +"Tipo de Dato"+ '</h5><p>' + "Tipo de Dato" + '</p></div></div>' + "Tipo de Dato"}
            ],
            buttons: [
                {
                    extend: 'copy',
