var language_module = (function(verbose){
	...
	function _loadLabels(firstLoad){
		...
		if(_tipo_modulo == 0){
			...
			$("#a_taxon").text($.i18n.prop('a_taxon'));
			$("#a_clima").text($.i18n.prop('a_clima'));
			$("#a_topo").text($.i18n.prop('a_topo'));
			...
			$("#a_item_reino").text($.i18n.prop('a_item_reino'));
			$("#a_item_phylum").text($.i18n.prop('a_item_phylum'));
			$("#a_item_clase").text($.i18n.prop('a_item_clase'));
			$("#a_item_orden").text($.i18n.prop('a_item_orden'));
			$("#a_item_familia").text($.i18n.prop('a_item_familia'));
			$("#a_item_genero").text($.i18n.prop('a_item_genero'));
